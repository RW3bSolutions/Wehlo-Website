                ...
                <div>
                    ...
                    >
                        <div className="flex flex-col items-center justify-center gap-8 py-8">
                            <div class=" w-full items-center justify-center flex flex-col md:w-1/2 mb-[4rem] md:space-y-12">
                                <img src="/images/About Us/founders/founder_1.png" />
                                <div className="flex flex-col justify-center w-full space-y-2 md:flex-wrap tems-center">
                            ...
                            <div class="text-center flex items-center justify-center w-full mb-[4rem]">
                                Developed by Mapua University School of Civil,
                                Environment and Geological Engineering led by
                                Dr. Francis Aldrine Uy and supported by the
                                Department of Science and Technology -
                                Philippine Council for Industry, Energy, and
                                Emerging Technology Research and Development
                                (DOST-PCIEERD), this technology will help urgent
                                the disaster risk reduction and management
                                operations as the country braces for La Niña.
                            </div>
